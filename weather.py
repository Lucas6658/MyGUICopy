...
from PyQt5.QtCore import Qt, QObject, pyqtSignal, QThreadPool, QCoreApplication, QRunnable, pyqtSlot
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def weather_result(self, weather, forecasts):
        ...
        self.psiPress = round((weather['main']['pressure']/68.9476), 1)

        self.temperatureLabel.setText(f'{self.Ftemp} °F')
        self.pressureLabel.setText(f'{self.psiPress} psi')
